...
namespace TileEditor
{
    ...
    abstract public class GraphicsDeviceControl : GLControl
    {
        ...
        void EndDraw()
        {
            try
            {
                //Swap back and front buffers, presenting the rendered scene to the screen
                SwapBuffers();
            }
            catch
            {
        ...
        //Changed from abstract to virtual because for whatever reason winforms doesn't like adding controls that directly inherit from an abstract class
